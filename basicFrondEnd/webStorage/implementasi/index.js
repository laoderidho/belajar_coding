  ...
  function getAnswer() {
    ...
    window.addEventListener('load', ()=>{
      if(typeof (Storage) !== 'undefined'){
        ...
        alert('tidak mendukung storage')
      }
      sessionUserAttemptsField.innerText = sessionStorage.getItem(sessionUserAttemptsKey)
      localTotalVictoryField.innerText = sessionStorage.getItem(localTotalVictoryKey)
      localMaximumAttemptField.innerText = sessionStorage.getItem(localMaximumAttemptsKey)
    })
